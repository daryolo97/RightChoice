...
public class GestioneCorso  {
  ...
  /**
   *Metodo che restituisce la lista dei corsi presenti
   * nella tabella 'corsi' all'interno del database.
   * @return La lista contenente tutti i corsi presenti nella tabella 'corsi'
   */
  ...
  /**
   * Metodo che elabora la lista dei nomi di tutti i corsi
   * presenti nella tabella 'corsi' all'interno del database.
   * @return una lista contenente il nome dei corsi presenti presenti nella tabella 'corsi'
   */
  ...
  /**
   * Metodo che verifica se il codice del corso desiderato è già presente
   * all'interno della colonna 'codice' della tabella 'corsi' all'interno del database.
   * @param corso rappresenta il corso di cui si vuole verifica l'esistenza del codice
   * @return false se il codice del corso è presente nel database, false altrimenti
   */
  ...
  /**
   * Metodo che permette di modificare le informazioni relative ad un corso,
   * aggiornando la riga della tabella 'corsi' in questione.
   ...
   */
  public void modificaCorso(Corso corso, String nome, String docente,
                            String descrizione, String link) {
