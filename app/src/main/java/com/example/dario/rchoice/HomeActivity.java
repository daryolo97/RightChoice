...
public class HomeActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Corso corso1 = new Corso("CO_01", "Programmazione Avanzata",
            "Annalisa De Bonis", "Questo corso mira ad impartire allo studente, "
            +
            "conoscenza e capacità di applicazione"
            +
            " dei principali modelli e strumenti per progettare e implementare programmi complessi",
            "www.di-srv.unisa.it/professori/debonis/");
    ...
    Corso corso8 = new Corso("CO_08", "Fondamenti di Intelligenza Artificiale",
            "Giuseppe Polese", "Lo studente acquisirà conoscenza di base su:\n"
            +
            "•agenti intelligenti, \n"
            +
            ...
            +
            "•principali metodi di rappresentazione della conoscenza, "
            +
            "con particolare riferimento a quelli basati "
            +
            "sulla logica del primo ordine e relativi metodi di inferenza. \n"
            +
            "•rappresentazione di conoscenza incerta e metodi probabilistici di inferenza,"
            +
            " con particolare riferimento alle reti bayesiane.\n"
            +
    ...
    gestoreRightChoice.inserisciCorso(corso8);
  }
